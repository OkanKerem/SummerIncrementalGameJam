...
namespace Universes.Presentation
{
    public class UpgradePanelController : MonoBehaviour
    {
        ...
        private void BuildUpgradeList()
        {
            ...
            foreach (var def in catalog.upgrades)
            {
                ...
                var controller = row.GetComponent<UpgradeRowView>();
                if (controller == null)
                    controller = row.AddComponent<UpgradeRowView>();
        ...
        private void RefreshAll()
        {
            ...
            foreach (Transform child in contentRoot)
            {
                var view = child.GetComponent<UpgradeRowView>();
                view?.Refresh();
            }
        }
    }
    ...
    public class UpgradeRowView : MonoBehaviour
    {
        ...
        private UniverseRunController _run;
        private System.Action _onRefresh;
        private Text _label;
        private Button _button;
        private Text _buttonText;

        public void Setup(UpgradeDefinition def, UniverseRunController run, System.Action onRefresh)
        {
            _def = def;
            _run = run;
        ...
        public void Refresh()
        {
            ...
            if (_buttonText != null)
                _buttonText.text = maxed ? "MAX" : NumberFormatHelper.Format(cost);
