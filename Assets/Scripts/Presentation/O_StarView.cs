...
namespace Universes.Presentation
{
    ...
    public class O_StarView : MonoBehaviour
    {
        ...
        private O_Star _star;
        private O_StarManager _manager;
        private SpriteRenderer _sprite;
        private float _pulse;

        public void Bind(O_Star star, O_StarManager manager)
        {
            _star = star;
            _manager = manager;
        ...
        private void Update()
        {
            if (_star == null || _star.Stage != O_StarStage.Supernova)
                return;
        ...
        public void RefreshVisual()
        {
            ...
            {
                O_StarStage.Yellow => Yellow,
                O_StarStage.Orange => Orange,
                O_StarStage.RedGiant => Red,
                O_StarStage.Supernova => Supernova,
                _ => Dead
            };

            transform.localScale = _star.Stage switch
            {
                O_StarStage.RedGiant => Vector3.one * 1.4f,
                O_StarStage.Supernova => Vector3.one * 1.6f,
                _ => Vector3.one
            };
