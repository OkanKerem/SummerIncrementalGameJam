...
namespace Universes.Game
{
    public class SpaceshipView : MonoBehaviour
    {
        ...
        public void Initialize(Planet source, Sprite[] shipSprites, GameObject alienPortraitPrefab,
            ...
            if (shipRenderer != null)
            {
                ...
                if (!_preservePrefabVisuals)
                {
                    shipRenderer.color = source != null && source.HasSpecies
                        ? SpeciesPortraitPool.GetSpeciesColor(source)
                        : Color.white;
        ...
        private void ConfigureExistingPrefabPortrait(Planet source)
        {
            if (source == null)
                return;
            ...
            SpeciesPortraitPool.ConfigurePortrait(portrait.gameObject, source);
        }
        ...
        private void ConfigurePortrait(Planet source, GameObject alienPortraitPrefab)
        {
            ...
            if (alienPortraitPrefab != null)
            {
                ...
                SpeciesPortraitPool.ConfigurePortrait(instance, source);
                return;
            }
            ...
            renderer.color = SpeciesPortraitPool.GetSpeciesColor(source);
