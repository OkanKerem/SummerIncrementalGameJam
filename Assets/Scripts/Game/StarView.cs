...
namespace Universes.Game
{
    ...
    public class StarView : MonoBehaviour
    {
        ...
        public StarStage Stage => StarStageUtility.FromAge(StarAge, MaxStarAge);
        ...
        private void Update()
        {
            if (Stage != StarStage.Supernova || _popRoutine != null)
                return;
        ...
        public void RefreshVisual()
        {
            ...
            var stage = Stage;
            _currentStageColor = StarColors.GetStageColor(stage);
            _currentGlowColor = StarColors.GetGlowColor(stage);
            _stageBaseScale = _prefabRootScale * StarColors.GetStageScale(stage);
            ...
            if (glowRenderer != null)
            {
                ...
                if (_popRoutine == null && Stage != StarStage.Supernova)
        ...
        private IEnumerator SupernovaRoutine()
        {
            ...
            var flash = StarColors.GetStageColor(StarStage.Supernova);
