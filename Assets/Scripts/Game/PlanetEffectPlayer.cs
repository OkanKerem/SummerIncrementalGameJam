...
{
    public static class PlanetEffectPlayer
    {
        public const float DefaultReferenceVisualScale = 0.22f;

        public static void Play(PlanetTypeDefinition definition, ParticleSystem prefab,
        ...
        private static ParticleSystem FindTintTarget(Transform instanceRoot, string childName)
        {
            ...
            var marker = instanceRoot.GetComponentInChildren<PlanetEffectTintTarget>(true);
            if (marker != null)
