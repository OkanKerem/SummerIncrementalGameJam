...
namespace Universes.Game
{
    public class WorldParticle : MonoBehaviour
    {
        ...
        private CosmicParticleManager _manager;
        private int _value;
        ...
        public void InitStardust(CosmicParticleManager manager, int value, Vector3 worldPosition,
            StarStage stage, float spawnDelay = 0f)
        {
            _manager = manager;
            _value = value;
            _isDna = false;
            ...
            ApplyVisual(StarColors.GetStageColor(stage), ParticleTiers.GetVisualScale(value));
        }

        public void InitDna(CosmicParticleManager manager, Vector3 worldPosition, float potentialAmount = 0f)
        {
            _manager = manager;
            _value = 1;
