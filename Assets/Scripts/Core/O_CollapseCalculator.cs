...
{
    [Serializable]
    public class O_CollapseBreakdown
    {
    ...
    public static class O_CollapseCalculator
    {
        public static O_CollapseBreakdown Calculate(
            O_RunStats stats,
            O_GameBalance balance,
            O_RunModifiers modifiers,
            float entropy,
            bool manualCollapse)
        {
            var breakdown = new O_CollapseBreakdown
            {
