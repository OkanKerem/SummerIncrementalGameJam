...
namespace Universes.Core
{
    public class RuntimeUIBuilder
    {
        ...
        public FloatingTextSpawner FloatingText { get; private set; }

        public static RuntimeUIBuilder Build(UniverseRunController run, UpgradeCatalog catalog, VariantCatalog variants)
        {
            var builder = new RuntimeUIBuilder();
            builder.CreateUi(run, catalog, variants);
            return builder;
        }

        private void CreateUi(UniverseRunController run, UpgradeCatalog catalog, VariantCatalog variants)
        {
            ...
            FloatingText = canvasGo.AddComponent<FloatingTextSpawner>();
        ...
        private void BuildTopBar(Transform canvas, Font font, HUDController hud)
        {
        ...
        private void BuildLeftPanel(Transform canvas, Font font, HUDController hud)
        {
        ...
        private void BuildStarInfo(Transform canvas, Font font, HUDController hud)
        {
        ...
        private void BuildBottomPanel(Transform canvas, Font font, HUDController hud, UpgradePanelController upgrades)
        {
        ...
        private void BuildCollapseModal(Transform canvas, Font font, CollapsePanelController collapse, VariantPickerController variants)
        {
        ...
        private void BuildVariantModal(Transform canvas, Font font, VariantPickerController picker)
        {
