...
{
    public class PrototypeSpeciesPortraitPool : MonoBehaviour
    {
        ...
        public GameObject Acquire(Transform parent, PrototypePlanet planet)
        {
        ...
        public static void ConfigurePortrait(GameObject instance, PrototypePlanet planet)
        {
        ...
        public static Color GetSpeciesColor(PrototypePlanet planet)
        {
        ...
        private static int GetStableSeed(PrototypePlanet planet)
        {
            unchecked
            {
                var hash = 17;
