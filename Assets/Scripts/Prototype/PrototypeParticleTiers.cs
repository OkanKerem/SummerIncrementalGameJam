...
{
    public static class PrototypeParticleTiers
    {
        ...
        public static PrototypeStarStage GetPreferredStageForTier(int value) =>
            value switch
            {
                >= 100 => PrototypeStarStage.Supernova,
                >= 25 => PrototypeStarStage.RedGiant,
                >= 5 => PrototypeStarStage.Orange,
                _ => PrototypeStarStage.Yellow
            };
    }
}
